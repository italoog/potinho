...
export default function BackToStoreButton() {
  ...
  return (
    <Link
      ...
      className="fixed left-5 top-[calc(var(--fsb-h)+20px)] z-40 flex h-14 w-14 items-center justify-center rounded-full bg-potinho-bege text-potinho-chocolate shadow-lg transition-transform hover:scale-105"
    >
