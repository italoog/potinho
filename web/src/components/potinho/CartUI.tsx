  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed right-5 top-[calc(var(--fsb-h)+32px)] z-40 flex h-14 w-14 items-center justify-center rounded-full bg-potinho-chocolate text-potinho-bege shadow-lg transition-transform hover:scale-105"
      >
      ...
      <Link
        ...
        className="fixed right-5 top-[calc(var(--fsb-h)+100px)] z-40 flex h-11 w-11 items-center justify-center rounded-full bg-potinho-bege text-potinho-chocolate shadow-lg transition-transform hover:scale-105"
      >
